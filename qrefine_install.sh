...
#create alias to set up environment for using the package
echo "alias qrefine='module load mamba/py3.13; source activate qrefine; $source_cmd'" >> ~/.bashrc


echo "An alias has been created in your ~/.bashrc to load the necessary modules and environment for qrefine.  The alias can be called as 'qrefine'."
echo "You will need to log out and back in or re-load your .bashrc file with the command 'source ~/.bashrc' to have access to the new alias."